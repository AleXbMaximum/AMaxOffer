...
(function () {
    ...
    function offers_renderTableView() {
        ...
        // Cell renderer using specialized handlers
        ...
        // Helper function for formatted currency/percentage values
        ...
        // Make rows clickable to open offer details
        setTimeout(() => {
    ...
    async function ui_renderCurrentView() {
        ...
        const loader = ui_createElement('div', {
