...
const iBMPMappings = require('regexpu-core/data/i-bmp-mappings.js');
const iuFoldings = require('regexpu-core/data/iu-foldings.js');
const ESCAPE_SETS = require('regexpu-core/data/character-class-escape-sets.js');
const { UNICODE_SET, UNICODE_IV_SET } = require('regexpu-core/data/all-characters.js');
